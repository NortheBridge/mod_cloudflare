...
mkdir mod_cloudflare && cd mod_cloudflare && wget "https://raw.githubusercontent.com/NortheBridge/mod_cloudflare/Alpha-DevBranch/mod_cloudflare.c" && cd ..
...
wget -O $INSTALL_DIR/ModCloudflare.pm https://raw.githubusercontent.com/NortheBridge/mod_cloudflare/Alpha-DevBranch/EasyApache/ModCloudflare.pm
