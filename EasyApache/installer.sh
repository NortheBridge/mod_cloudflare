...
mkdir mod_cloudflare && cd mod_cloudflare && wget "https://raw.githubusercontent.com/NortheBridge/mod_cloudflare/Auradon-Network/mod_cloudflare.c" && cd ..
...
wget -O $INSTALL_DIR/ModCloudflare.pm https://raw.githubusercontent.com/NortheBridge/mod_cloudflare/Auradon-Network/EasyApache/ModCloudflare.pm
